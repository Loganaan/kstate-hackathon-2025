          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-1">Session ID: {sessionId as string}</p>
              </div>
  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Invalid Interview Type</h1>
        <p className="text-gray-600 mb-6">The interview type &quot;{type as string}&quot; is not recognized.</p>
