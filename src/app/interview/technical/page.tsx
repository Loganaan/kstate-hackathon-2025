    ...
    <div className="bg-gray-50 min-h-[calc(100vh-8rem)]">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-full px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">Technical Interview Session</h1>
              <p className="text-gray-600 mt-1">Problem 1 of 3</p>
            </div>
      ...
      <div className="h-[calc(100vh-16rem)]">
        <div className="grid lg:grid-cols-2 gap-0 h-full">
          ...
          <div className="flex flex-col bg-white border-r border-gray-200">
            ...
            {/* Problem Description */}
            <div className="border-b border-gray-200 p-6 overflow-y-auto max-h-64">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">Problem: Two Sum</h2>
              ...
              <div className="space-y-3">
                <div className="bg-gray-50 rounded-lg p-4 font-mono text-sm">
                  <div className="text-gray-600 mb-2">Example 1:</div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 font-mono text-sm">
                  <div className="text-gray-600 mb-2">Example 2:</div>
                  <div className="text-gray-800">
            ...
            <div className="flex-1 flex flex-col">
              <div className="bg-gray-800 px-4 py-2 flex items-center justify-between">
                ...
                <select className="bg-gray-700 text-gray-300 text-sm rounded px-2 py-1 border-none focus:ring-2 focus:ring-blue-500">
          ...
          <div className="flex flex-col bg-gray-50">
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">AI Feedback</h2>
              ...
              <div className="mt-6">
                <details className="bg-white rounded-xl shadow-sm border border-gray-200">
                  <summary className="p-4 cursor-pointer font-semibold text-gray-800 hover:bg-gray-50 rounded-xl">
                    💡 Need a hint?
                  </summary>
            ...
            <div className="border-t border-gray-300">
              ...
              <div className="bg-gray-900 p-4 h-48 overflow-y-auto font-mono text-sm">
      ...
      <div className="bg-white border-t border-gray-200 px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex justify-between items-center text-sm">
          ...
          <div className="text-gray-600">
            Test Cases Passed: <span className="font-semibold text-green-600">0 / 5</span>
          </div>
        </div>
      </div>
    </div>
